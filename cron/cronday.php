...
$endOfTimeStmt = $pdo->prepare(
    "UPDATE invoice SET Status = 'end_of_time', expired_at = COALESCE(expired_at, NOW()), Day_Last_Checked_At = NOW() WHERE id_invoice = ? AND Status IN ('active', 'sendedwarn', 'end_of_volume')"
);
